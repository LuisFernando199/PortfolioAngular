//Se migra la direcciones a $(document), porque Angular no es capaz de encontrarlas.
//The addresses are migrated to $(document), because Angular is not able to find them.
